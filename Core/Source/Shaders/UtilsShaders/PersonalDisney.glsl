...
#ifndef PERSONALDISNEY 
#define PERSONALDISNEY 
...
vec3 GetDisneyBSDF(MaterialData material, vec3 view, vec3 lightDir, vec3 normal, mat3 inverseTBN){
    ...
    //    
    vec3 val = ((1.0f - material.specularTransmission) * (1 - material.metallicIntensity) * fd) +
    ((1.0f - material.metallicIntensity) * material.sheen * fs) +
    ((1.0f - (material.specularTransmission * (1 - material.metallicIntensity))) * fm)+
    ((0.25f * material.clearcoat) * fc);
