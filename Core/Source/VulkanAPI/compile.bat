...
C:\VulkanSDK\1.3.280.0\Bin\glslc.exe --target-env=vulkan1.3 ..\Shaders\RayTracingShaders\sphereint.rint -o  ..\Shaders\RayTracingShaders\sphereint.rint.spv
C:\VulkanSDK\1.3.280.0\Bin\glslc.exe --target-env=vulkan1.3 ..\Shaders\RayTracingShaders\spherehit.rchit -o  ..\Shaders\RayTracingShaders\spherehit.rchit.spv
...
C:\VulkanSDK\1.3.280.0\Bin\glslc.exe --target-env=vulkan1.3 ..\Shaders\RayTracingShaders\anyhit.rahit -o  ..\Shaders\RayTracingShaders\anyhit.rahit.spv
